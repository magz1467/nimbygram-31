    ...
    <footer className="bg-[#221F26] text-white mt-12">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 py-8">
          <div>
            <h3 className="font-bold mb-3 text-white text-lg">About Us</h3>
          ...
          <div>
            <h3 className="font-bold mb-3 text-white text-lg">Legal</h3>
            <ul className="space-y-2 text-gray-400">
          ...
          <div>
            <h3 className="font-bold mb-3 text-white text-lg">Support</h3>
            <ul className="space-y-2 text-gray-400">
          ...
          <div>
            <h3 className="font-bold mb-3 text-white text-lg">Connect</h3>
