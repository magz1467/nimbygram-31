        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Making planning information accessible and transparent for everyone.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/search" className="text-gray-300 hover:text-white">Search Applications</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-300 hover:text-white">Planning Guide</a>
              </li>
              <li>
